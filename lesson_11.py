...
while game:
    #Variables
    name1 = input('Please, enter your name1: ')
    name2 = input('Please, enter your name2: ')
    player1_choice = ''
    player2_choice = ''
    player1_score = 0
    player2_score = 0
    ...
    for i in range(1,rounds+1):
        ...
        #Enter data
        while player1_choice != 'r' and  player1_choice != 'p' and player1_choice != 's':
            player1_choice = str(input(f"Enter your choice {name1} : [r],[p],[s] : "))
        while player2_choice != 'r' and player2_choice != 'p' and player2_choice != 's':
            player2_choice = str(input(f"Enter your choice {name2} : [r],[p],[s] : "))
        #Compare data
        # if player1_choice == 'r':
        #     if player2_choice == 's':
        #         print('Player 1 win the round!')
        ...
        if player1_choice == player2_choice:
            ...
            if player2_choice == 's':
                print(f"{name1} win the round!")
                player1_score = player1_score + 1
            else:
                print(f"{name2} win the round!")
                player2_score = player2_score + 1
        elif player1_choice == 'p':
            if player2_choice == 'r':
                print(f"{name1} win the round!")
