...
f = open('../TXTFiles/test1.txt', 'wt')#t - text /b - binary, w- write text in to file
f.write('My name is Andreichenko Olga\nHow are you?....')
time.sleep(15)
f.close()

f = open('../TXTFiles/test1.txt', 'rt')#t - text /b - binary, r-read text
print(f.read())
f.close()
